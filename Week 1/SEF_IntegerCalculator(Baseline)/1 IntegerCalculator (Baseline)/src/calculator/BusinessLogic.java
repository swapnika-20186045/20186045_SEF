 ...
 * logic functions. This class performs the business logic of the calculator by
 * using three CalculatorValues and performs actions with and on them. The class
 * expects data from the User Interface to arrive as Strings and returns Strings
 * to it. This class calls the CalculatorValue class to do the computations and
 * this class knows nothing about the actual representation of CalculatorValues,
 * that is the responsibility of the CalculatorValue class and the classes it
 * calls. Hiding the representation of calculator values from the business logic
 * means that this code does not have to change when there is a change in the
 * representation changes. Similarly, the this class does not need to change if
 * aspects of the user interface changes.
 * </p>
 * 
 * <p>
 ...
 * @version 4.00 2014-10-18 The JavaFX-based GUI implementation of a long
 *          integer calculator
 * 
 */
...
public class BusinessLogic {
	 ...
	 * All of that is hidden from this class by the ClaculatorValue class and any
